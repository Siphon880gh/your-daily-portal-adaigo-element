...
function newSection() {
    if ($('#front-username').html().length === 0) {
        ...
        message('Coming soon', 'Black', `New elements coming to the Daily Portal: Weather, Stocks, News, Favorites, Todo List, Reading List. We may make this into a Chrome Extension or Firefox extension.<br/><br/>Business opportunity? Add ads on users' free version.<br/><br/>Contact us at <a href='
